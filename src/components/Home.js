    ...
    render(){
        return(
            <div className="components">
                ...
                <h2 className="nine-second-animation" style={{marginTop: "0.5rem"}}>I have experience in <span style={{color: '#ee71d1'}}>Ruby on Rails, Python, JavaScript, React, Redux, and more.</span></h2>
            </div>
        )
    }
}
